...
public class PhotoBoardController {
	...
	public String insert(
		...
		if(!dto.getFile1().isEmpty()) {
			...
			String path1 = "/usr/local/apache-tomcat-8.5.47/webapps/ROOT/resources/images/";
	...
	public void insertApply(
		...
		photoBoardService.insertApply(accountId,concertId);
		
	}
	
	@RequestMapping("viewApplicants")
	public ModelAndView viewApplicants(@RequestParam("id") int concertId, HttpSession session, ModelAndView mav) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		List<AccountDTO> applicants = photoBoardService.getApplicants(concertId);
	...
	public String deleteConcert(@RequestParam("id") int concertId) {
		photoBoardService.deleteConcert(concertId);
		return "redirect:/photoboard";
	}
}
