			...
			<%-- <c:choose>
				<c:when test="${sessionScope.userid==null}"> --%>
					<table align="center">
						<tr>
							<td colspan="3">
								<a href="${path}/account/login.do"><button>로그인</button></a>
							</td>
						</tr>
						<tr>
							<td><a href="${path}/account/searchEmail.do">아이디</a>·
							<a href="${path}/account/searchPassword.do">비밀번호찾기</a></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><a href="${path}/account/join">회원가입</a></td>
						</tr>
