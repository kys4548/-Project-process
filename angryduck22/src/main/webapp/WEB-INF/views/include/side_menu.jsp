...
<div>
	...
	<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center"> 
		...
		<a href="${path}/contact?id=1" class="w3-bar-item w3-button w3-padding-large w3-white">
	...
	<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
		<div class="w3-bar w3-white w3-center w3-small">
			<a href="${path}/" class="w3-bar-item w3-button" style="width:20% !important">HOME</a>
			<a href="${path}/about" class="w3-bar-item w3-button" style="width:20% !important">ABOUT</a>
			<a href="${path}/photoboard" class="w3-bar-item w3-button" style="width:20% !important">CONCERT</a>
			<a href="${path}/board" class="w3-bar-item w3-button" style="width:20% !important">COMMUNITY</a>
			<a href="${path}/contact?id=1" class="w3-bar-item w3-button" style="width:20% !important">CONTACT</a>
		</div>
	</div>
