...
final Logger logger = LoggerFactory.getLogger(BoardDAOImpl.class);
	...
	public int countArticle(String searchOption, String keyword) {
		...
		if(searchOption.equals("account_id")) {
			return sqlSession.selectOne("photoBoard.countApplyList",map);
		}
		else {
	...
	public List<PhotoBoardDTO> listAll(int start, int end, 
		...
		map.put("end",end);
		if(searchOption.equals("account_id")) {
			return sqlSession.selectList("photoBoard.listApply",map);
		}
		else {
	...
	public List<PhotoBoardDTO> getRecommend(int index){
		return sqlSession.selectList("photoBoard.getRecommend",index);
	}
